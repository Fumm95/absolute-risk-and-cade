#################################################################
####### 3. Projecting Absolute Risk of Cancer Incidence #########
#################################################################

# ORs obtained from externally published results
...
brca_white_test$bc_inc <- bc_white_inc$Rate[floor(brca_white_test$age/5) + 1] # Incidence rates from SEER
...
brca_black_test$bc_inc <- bc_black_inc$Rate[floor(brca_black_test$age/5) + 1] # Incidence rates from SEER
...
brca_hisp_test$bc_inc <- bc_hisp_inc$Rate[floor(brca_hisp_test$age/5) + 1] # Incidence rates from SEER
...
brca_asn_test$bc_inc <- bc_asn_inc$Rate[floor(brca_asn_test$age/5) + 1] # Incidence rates from SEER
...
# Projection of Absolute Risk of Cancer Incidence
